...
export function NavigationSidebar({ 
  ...
  const handleSelfieCapture = useCallback(() => {
    // Close sidebar first
    onClose();
    // Navigate directly to selfie (face recording) page
    router.push('/my-space/access-control/face-recording');
  }, [onClose, router]);
            ...
            >
              ...
              <div className="flex h-[calc(100%-72px)] flex-col overflow-hidden">
                <div className="flex-1 space-y-2 overflow-y-auto p-4">
                  ...
                  {/* Main tile navigates to /my-space; camera opens selfie */}
                  <div className="mb-4">
                    <ButtonNaked
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">门禁管理中心</p>
                        </div>
                      </div>
